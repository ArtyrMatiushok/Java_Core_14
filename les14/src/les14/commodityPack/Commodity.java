...
public class Commodity implements Comparable<Commodity> {
	...
	public static void sortByLength(Collection<Commodity> coll) {
		Collections.sort((List<Commodity>) coll, new CommodityLengthComparator());
	}
	
	public static void sortByWidth(Collection<Commodity> coll) {
		Collections.sort((List<Commodity>) coll, new CommodityWidthComparator());
	}
	
	public static void sortByWeight(Collection<Commodity> coll) {
		Collections.sort((List<Commodity>) coll, new CommodityWeightComparator());
	}
